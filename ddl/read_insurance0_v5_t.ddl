-- Table: read_insurance0_v5_t

-- DROP TABLE read_insurance0_v5_t;

CREATE TABLE read_insurance0_v5_t
(
  ...
  client_date1 date,
  CONSTRAINT read_insurance0_v5_t_cust_id_check CHECK (cust_id >= 1::numeric AND cust_id <= 9999::numeric)
)
WITH (
  OIDS=FALSE
);