-- Table: read_insurance0_v6_t

-- DROP TABLE read_insurance0_v6_t;

CREATE TABLE read_insurance0_v6_t
(
  ...
  tot_pat_pmt numeric(20,2),
  fin_bill_date date,
  tot_pmt numeric(20,2),
  ...
  client_date1 date,
  CONSTRAINT read_insurance0_v6_t_cust_id_check CHECK (cust_id >= 1::numeric AND cust_id <= 9999::numeric)
)
WITH (
  OIDS=FALSE
);